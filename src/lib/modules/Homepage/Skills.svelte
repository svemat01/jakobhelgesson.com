<script lang="ts">
    ...
    const skills: {
        ...
        technologies: [
            ...
            {
                title: 'Kubernetes',
                description: 'I use Kubernetes to deploy my projects to a cluster of servers',
                icon: kubernetesIcon
            }
        ],
        languages: [
            ...
            {
                title: 'JavaScript',
                description: 'I mostly use typescript but I am also familiar with JavaScript',
                icon: javascriptIcon
            },
            {
                title: 'Java',
                description: "I'm familiar with Java, but I am yet to use it any projects",
                icon: javaIcon
            }
        ],
        tools: [
            {
                title: 'Git',
                description: "I've used Git for version control for my projects.",
                icon: gitIcon
            },
            {
                title: 'Docker',
                description: 'I use Docker to build my projects to work everywhere',
                icon: dockerIcon
            }
        ]
    };
...
<section id="technologies">
    ...
    <div class="items">
        {#each skills.technologies as tech, i}
            <IconCard title={tech.title} icon={tech.icon} />
        {/each}
    </div>
</section>

<section id="tools">
    <SectionTitle name="Tools" />
    <div class="items">
        {#each skills.tools as tool, i}
            <IconCard title={tool.title} icon={tool.icon} />
        {/each}
    </div>
</section>
